...
var til = [
  {title:"how to pass class", body: "come to class. do your homework", created_at: "some date"},
  {title:"how to fail class", body: "play video games all day", created_at: "some date"}
];
